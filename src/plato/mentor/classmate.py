...
from ..templates.classmate import CLASSMATE_MENTOR_TEMPLATE_EN, CLASSMATE_MENTOR_TEMPLATE_ZH


class ClassmateMentor:
    def __init__(self, mentor_id: str) -> None:
        self._window_size = 2
        self._chat_model = ChatOpenAI(model="gpt-3.5-turbo")
        self._template = {
            Lang.EN: CLASSMATE_MENTOR_TEMPLATE_EN,
            Lang.ZH: CLASSMATE_MENTOR_TEMPLATE_ZH,
        }
